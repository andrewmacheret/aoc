...
def solve(logs):
  ...
  for log in parsed_logs:
    if log['action'] == 'sleep':
      ...
      #print('range', log['guard_id'], sleep_start, sleep_end)
      for t in xrange(sleep_start, sleep_end):
        sleep_times[(log['guard_id'], t)] += 1

  best_guard_id = -1
  best_minute = -1
  best_sleep_time = -1
  for pair, sleep_time in sleep_times.iteritems():
    #print('x', pair, sleep_time)
    guard_id, minute = pair[0], pair[1]
    if best_sleep_time < sleep_time:
      best_sleep_time = sleep_time
      best_guard_id = guard_id
      best_minute = minute

  #print(best_guard_id, best_sleep_time, best_minute)
